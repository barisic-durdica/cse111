...
def test_pressure_loss_from_fittings():
    assert water_flow.pressure_loss_from_fittings(0.00, 3) == approx(0.000, abs=0.001)
    assert water_flow.pressure_loss_from_fittings(1.65, 0) == approx(0.000, abs=0.001)
...
def test_kpa_to_psi():
    assert water_flow.kpa_to_psi(0) == approx(0, abs=0.001)
    assert water_flow.kpa_to_psi(6.894757293168361) == approx(1, abs=0.001)
    assert water_flow.kpa_to_psi(100) == approx(14.504, abs=0.001)
    assert water_flow.kpa_to_psi(158.7) == approx(23.017, abs=0.001)
